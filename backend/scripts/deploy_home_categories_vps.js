...
conn.on('ready', () => {
  console.log('✅ Connected via SSH! Syncing Home Categories Management to Hostinger VPS...');
  conn.sftp((err, sftp) => {
    if (err) throw err;
...
function uploadBackendFiles(sftp) {
  const files = [
    { local: 'c:/Users/DELL/Desktop/librerie l\'ecolier/frontend/src/features/admin/pages/CategoriesPage.tsx', remote: `${remotePath}/frontend/src/features/admin/pages/CategoriesPage.tsx` },
    { local: 'c:/Users/DELL/Desktop/librerie l\'ecolier/frontend/src/components/Categories.tsx', remote: `${remotePath}/frontend/src/components/Categories.tsx` },
  ];
