...
const prefixCategoryMap = {
  ...
  'SD02': 'Take And Go',
  'SD03': 'Take And Go',
  'SDi01': 'Sac A Dos Informatique',
  'SDi02': 'Sac A Dos Informatique',
};
...
async function runImport(isDryRun = true) {
  ...
  console.log(`=== BOMI 2026 Import Script (DryRun: ${isDryRun}) ===`);
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    const stock = (qteRaw !== undefined && qteRaw !== null && !isNaN(Number(qteRaw)))
      ? Number(qteRaw) : 0;
...
// Run actual import/update in MongoDB
runImport(false);
