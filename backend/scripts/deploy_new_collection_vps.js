...
conn.on('ready', () => {
  console.log('✅ Connected via SSH! Syncing New Collection section to Hostinger VPS...');
  conn.sftp((err, sftp) => {
    if (err) throw err;
...
function uploadBackendFiles(sftp) {
  const files = [
    ...
    { local: 'c:/Users/DELL/Desktop/librerie l\'ecolier/frontend/src/components/NewCollection.tsx', remote: `${remotePath}/frontend/src/components/NewCollection.tsx` },
    { local: 'c:/Users/DELL/Desktop/librerie l\'ecolier/frontend/src/App.tsx', remote: `${remotePath}/frontend/src/App.tsx` },
  ];
