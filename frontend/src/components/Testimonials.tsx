...
const testimonials = [
  ...
  { id: 5, name: "Ahmed G.",   location: "Kairouan", rating: 4, avatar: "A", avatarColor: "#d97706", text: "Kol mara nzid net2ked ely hedhi ahsn librerie see you soon fl back to school !" },
];
